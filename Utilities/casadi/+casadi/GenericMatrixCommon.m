classdef  GenericMatrixCommon < SwigRef
  ...
  methods
    ...
    %SYMVAR 
    %
    %  std::vector< casadi::Matrix< casadi_int >,std::allocator< casadi::Matrix< casadi_int > > > = SYMVAR(IM x)
    %  {DM} = SYMVAR(DM x)
    %  {SX} = SYMVAR(SX x)
    %  {MX} = SYMVAR(MX x)
    %
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(191, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(194, varargin{:});
    end
    function varargout = interp1d(varargin)
    %INTERP1D 
    %
    %  IM = INTERP1D([double] x, IM v, [double] xq, char mode, bool equidistant)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(195, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(199, varargin{:});
    end
    ...
    %  SX = INV(SX A)
    %  MX = INV(MX A)
    %  IM = INV(IM A, char lsolver, struct opts)
    ...
    %IS_QUADRATIC 
    %
    %  bool = IS_QUADRATIC(IM expr, IM var)
    ...
    %QUADRATIC_COEFF 
    %
    %  [IM OUTPUT1, IM OUTPUT2, IM OUTPUT3] = QUADRATIC_COEFF(IM ex, IM arg)
    %  [DM OUTPUT1, DM OUTPUT2, DM OUTPUT3] = QUADRATIC_COEFF(DM ex, DM arg)
    %  [SX OUTPUT1, SX OUTPUT2, SX OUTPUT3] = QUADRATIC_COEFF(SX ex, SX arg)
    %  [MX OUTPUT1, MX OUTPUT2, MX OUTPUT3] = QUADRATIC_COEFF(MX ex, MX arg)
    %
    %
    ...
    %LINEAR_COEFF 
    %
    %  [IM OUTPUT1, IM OUTPUT2] = LINEAR_COEFF(IM ex, IM arg)
    %  [DM OUTPUT1, DM OUTPUT2] = LINEAR_COEFF(DM ex, DM arg)
    %  [SX OUTPUT1, SX OUTPUT2] = LINEAR_COEFF(SX ex, SX arg)
    %  [MX OUTPUT1, MX OUTPUT2] = LINEAR_COEFF(MX ex, MX arg)
    %
    %

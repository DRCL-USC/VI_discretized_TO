classdef  SparsityInterfaceCommon < SwigRef
  ...
  methods
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(41, varargin);
    end
    function varargout = horzsplit(varargin)
    %HORZSPLIT 
    %
    %  {Sparsity} = HORZSPLIT(Sparsity v, int incr)
    %  std::vector< casadi::Matrix< casadi_int >,std::allocator< casadi::Matrix< casadi_int > > > = HORZSPLIT(IM v, int incr)
    %  {DM} = HORZSPLIT(DM v, int incr)
    %  {SX} = HORZSPLIT(SX v, int incr)
    %  {MX} = HORZSPLIT(MX v, int incr)
    %  {Sparsity} = HORZSPLIT(Sparsity v, [int] offset)
    %  std::vector< casadi::Matrix< casadi_int >,std::allocator< casadi::Matrix< casadi_int > > > = HORZSPLIT(IM v, [int] offset)
    ...
    %  std::vector< casadi::Matrix< casadi_int >,std::allocator< casadi::Matrix< casadi_int > > > = VERTSPLIT(IM v, int incr)
    %  {DM} = VERTSPLIT(DM v, int incr)
    %  {SX} = VERTSPLIT(SX v, int incr)
    %  {MX} = VERTSPLIT(MX v, int incr)
    %  {Sparsity} = VERTSPLIT(Sparsity v, [int] offset)
    %  std::vector< casadi::Matrix< casadi_int >,std::allocator< casadi::Matrix< casadi_int > > > = VERTSPLIT(IM v, [int] offset)
    ...
    %  std::vector< casadi::Matrix< casadi_int >,std::allocator< casadi::Matrix< casadi_int > > > = DIAGSPLIT(IM x, int incr)
    ...
    %  std::vector< casadi::Matrix< casadi_int >,std::allocator< casadi::Matrix< casadi_int > > > = DIAGSPLIT(IM x, [int] output_offset)
    ...
    %  std::vector< casadi::Matrix< casadi_int >,std::allocator< casadi::Matrix< casadi_int > > > = DIAGSPLIT(IM x, int incr1, int incr2)
    %  std::vector< casadi::Matrix< casadi_int >,std::allocator< casadi::Matrix< casadi_int > > > = DIAGSPLIT(IM x, [int] output_offset1, [int] output_offset2)

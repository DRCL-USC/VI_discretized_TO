classdef  MX < casadi.GenericExpressionCommon & casadi.PrintableCommon & casadi.GenMX & casadi.SharedObject
  ...
  methods
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(762, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(763, varargin{:});
    end
  end
  methods(Static)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(750, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(751, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(752, varargin{:});
    end

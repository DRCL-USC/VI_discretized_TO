classdef  Sparsity < casadi.SharedObject & casadi.SparsityInterfaceCommon & casadi.PrintableCommon
  ...
  methods
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(76, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(77, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(78, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(79, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(80, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(81, self, varargin{:});
    end
    ...
    %
    %
      [varargout{1:nargout}] = casadiMEX(82, self, varargin{:});
    end
    ...
    %
    %
      out = casadiMEX(95, self, varargin{:});
      if nargout<=1
        varargout{1}=out;
      else
  ...
  methods(Static)
    ...
    %FROM_INFO 
    %
    %  Sparsity = FROM_INFO(struct info)
    %
    %
    ...
    %DESERIALIZE 
    %
    %  Sparsity = DESERIALIZE(std::istream & istream)
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(163, varargin{:});
    end
    ...
    %
    %
     [varargout{1:nargout}] = casadiMEX(165, varargin{:});
    end

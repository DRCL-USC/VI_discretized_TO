...
#define CASADI_VERSION_STRING "3.4.0"
#define CASADI_GIT_REVISION "c6be863a2a23b4b7d010be1419abffbe30a007e8"  // NOLINT(whitespace/line_length)
#define CASADI_GIT_DESCRIBE "3.3.0-4.c6be863a2"  // NOLINT(whitespace/line_length)

...
[nx, robotStruct, robotParams] = getCartPoleStruct();
...
%% Terminal Conditions
option.qf = pi; % End in upward position - don't specify track distance
...
%Terminal Conditions
opti.subject_to(q(2,N) == option.qf); % final position, leave track distance free

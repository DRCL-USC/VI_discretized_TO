...
res = 2; %Change resolution without changing timing
dt = .01/res; %timestep
...
option.jump_length = -0.7;
option.flip = 2; % 0 = do not flip, otherwise is number of "backflips" (in direction of knee)

% option.platform_height = 1.452895968537810;
% option.jump_length = -0.438096044888052;

% option.platform_height = 1.048770202499705;
% option.jump_length = -0.483549465660115;
...
option.alpha_tau = .02; % Weight for control effort

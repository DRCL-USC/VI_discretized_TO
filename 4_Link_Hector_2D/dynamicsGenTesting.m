...
%% Kinematics
    ...
    Hj1 = homogTr(q(4), [0;0;1], [-L1/2;0;0]);
    H2 = homogTr(0, [0;0;1], [0;-L2/2;0]);
    Hj2 = homogTr(q(5), [0;0;1], [0;-L2/2;0]);
    H3 = homogTr(0, [0;0;1], [0;-L3/2;0]);
    Hj3 = homogTr(q(6), [0;0;1], [0;-L3/2;0]);
